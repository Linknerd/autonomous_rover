...
// [DEBUG] Originally 300 TPR for 1X decoding. Now using 4X decoding, yielding
// 1200 ticks per revolution. If your specification states "3000 TPR" for the
// motor output shaft in 4X, leave this at 3000.
// // const int TPR = 3000;
const int TPR =
    12000; // Ticks per wheel revolution (Assuming full 4X resolution)
